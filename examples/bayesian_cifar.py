...
from dgp_sparse.models import DMGPcifar
...
def main():
    ...
    model = DMGPcifar(input_dim=32*32*3,
                      output_dim=10,
    ...
    if args.mode == 'train':
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if args.model == 'grid':
                torch.save(model.state_dict(),
                           args.save_dir + "/cifar_bayesian_dgp_sg.pth")
        ...
        if args.model == 'grid':
            checkpoint = args.save_dir + '/cifar_bayesian_dgp_sg.pth'
        elif args.model == 'additive':
